...
export const PRESET_TEMPLATES: Template[] = [
  {
    ...
    textFields: [
      ...
      },
      {
        id: "t4",
        fieldName: "产品系列",
        content: "[seriesName] · [productName]",
        isDynamic: true,
    ...
    textFields: [
      {
        id: "tsku_1",
        fieldName: "编号款式条",
        content: "款式: [productCode] - [productName]",
        isDynamic: true,
        dataSource: "productName",
        x: 50,
        y: 10,
  ...
  },
  {
    ...
    textFields: [
      ...
      {
        id: "td_line2",
        content: "📌 内页材质: [materialInner] ([thickness])",
        fieldName: "参数内页",
        isDynamic: true,
...
export const SLOT_DEFINITIONS = [
  ...
  { id: "CAL_SLOT_005", name: "双本前后层叠槽", widthRange: "82% - 92%", heightRange: "多层叠", desc: "主副双品阶梯排布，前景产品必须完整展示。" },
